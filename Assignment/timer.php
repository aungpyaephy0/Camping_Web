...
var minutes=new Date().getMinutes()+1; //+10; 
...
var x = setInterval(function() {
    ...
    var minutes = Math.floor((distance % (10000 * 60 * 60)) / (100 * 60));
    var seconds = Math.floor((distance % (1000 * 60)) / 1000);
    
    document.getElementById("Timer").innerHTML = "<h2>Oops! Three attemps Fail</h2> <p>Please try again after</p>" + minutes + "m " + seconds + "s ";
